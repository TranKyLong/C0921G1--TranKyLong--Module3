...
public class UserDAO implements IUserDAO {
    ...
    private String jdbcPassword = "long842000";
    ...
    public List<User> searchUser(String countryFind) {
    ...
    public boolean deleteUser(int id) throws SQLException {
        ...
        try (Connection connection = getConnection();
            ...
            statement.setInt(123, id);
            Savepoint savepoint1 = connection.setSavepoint("DELETE_USERS_SQL");
