...
use furama;
select  kh.ma_khach_hang  'id' , kh.ho_va_ten 'ho_ten', kh.email 'email', kh.so_dien_thoai 'sdt', kh. ngay_sinh 'ngay_sinh', kh.dia_chi 'dia_chi'
from   khach_hang kh
UNION all
select nv.ma_nhan_vien, nv.ho_ten_nhan_vien, nv.email, nv.so_dien_thoai, nv. ngay_sinh, nv.dia_chi
FROM nhan_vien nv;
